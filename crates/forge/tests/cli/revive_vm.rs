...
Traces:
  [3895361] CounterTest::setUp()
    ├─ [1291514] → new <unknown>@0x5615dEB798BB3E4dFa0139dFa1b3D433Cc23b72f
...
Traces:
  [3873734] RecordTest::testRecordAccess()
    ├─ [1250013] → new <unknown>@0x7D8CB8F412B3ee9AC79558791333F41d2b1ccDAC
    │   └─ ← [Return] 4095 bytes of code
    ├─ [1250012] → new <unknown>@0x5615dEB798BB3E4dFa0139dFa1b3D433Cc23b72f
...
Traces:
  [1287757] RecordLogsTest::setUp()
    ├─ [1250014] → new <unknown>@0x5615dEB798BB3E4dFa0139dFa1b3D433Cc23b72f
...
Traces:
  ...
  [5263375] RecordLogsTest::testRecordOnEmitDifferentDepths()
    ├─ [0] VM::recordLogs()
    │   └─ ← [Return]
    ...
    │   └─ ← [Stop]
    ├─ [1301614] → new <unknown>@0x5991A2dF15A8F6A256D3Ec51E99254Cd3fb576A9
...
Traces:
  [2675638] StateDiffTest::setUp()
    ├─ [1291513] → new <unknown>@0x5615dEB798BB3E4dFa0139dFa1b3D433Cc23b72f
    │   └─ ← [Return] 5531 bytes of code
    ├─ [1291513] → new <unknown>@0xF62849F9A0B5Bf2913b396098F7c7019b51A820a
...
Traces:
  ...
  [1345790] StateDiffTest::testCreateAcceses()
    ├─ [0] VM::startStateDiffRecording()
    │   └─ ← [Return]
    ├─ [1291511] → new <unknown>@0xc7183455a4C133Ae270771860664b6B7ec320bB1
    │   └─ ← [Return] 5531 bytes of code
    ├─ [0] VM::stopAndReturnStateDiff()
