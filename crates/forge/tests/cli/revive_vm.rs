...
[PASS] test_Increment() ([GAS])
Traces:
  [286925091] CounterTest::setUp()
    ├─ [105691195] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] 7404 bytes of code
    ├─ [0] VM::expectEmit()
    │   └─ ← [Return]
    ├─ emit SetNumber(result: 5)
    ├─ [95286475] 0x34A1D3fff3958843C43aD80F30b94c510645C316::setNumber(5)
    │   ├─ emit SetNumber(result: 5)
    │   └─ ← [Stop]
    ├─ [85906674] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 5
    └─ ← [Stop]

  [434182040] CounterTest::test_Increment()
    ├─ [105693893] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 5
    ├─ [95289538] 0x34A1D3fff3958843C43aD80F30b94c510645C316::setNumber(55)
    │   ├─ emit SetNumber(result: 55)
    │   └─ ← [Stop]
    ├─ [85909436] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 55
    ├─ [77452642] 0x34A1D3fff3958843C43aD80F30b94c510645C316::increment()
    │   ├─ emit Increment(result: 56)
    │   └─ ← [Stop]
    ├─ [69828359] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 56
    └─ ← [Stop]
...
Traces:
  ...
  [105702360] CounterTest::test_expectRevert()
    ...
    │   └─ ← [Return]
    ├─ [105693521] 0x34A1D3fff3958843C43aD80F30b94c510645C316::failed_call() [staticcall]
    │   └─ ← [Revert] Revert("failure")
    └─ ← [Stop]
...
Traces:
  [286951813] RecordTest::testRecordAccess()
    ├─ [105691208] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] 4095 bytes of code
    ├─ [95284066] → new <unknown>@0x90193C961A926261B756D1E5bb255e67ff9498A1
    │   └─ ← [Return] 2182 bytes of code
    ├─ [0] VM::record()
    │   └─ ← [Return]
    ├─ [85904438] 0x34A1D3fff3958843C43aD80F30b94c510645C316::record(0x90193C961A926261B756D1E5bb255e67ff9498A1)
...
Traces:
  [364403446] RecordTest::testStopRecordAccess()
    ├─ [105691199] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] 4095 bytes of code
    ├─ [95284059] → new <unknown>@0x90193C961A926261B756D1E5bb255e67ff9498A1
    │   └─ ← [Return] 2182 bytes of code
    ├─ [0] VM::record()
    │   └─ ← [Return]
    ├─ [85904431] 0x34A1D3fff3958843C43aD80F30b94c510645C316::record(0x90193C961A926261B756D1E5bb255e67ff9498A1)
    │   ├─ [0] 0x90193C961A926261B756D1E5bb255e67ff9498A1::record()
    │   │   └─ ← [Return]
    │   └─ ← [Stop]
    ├─ [0] VM::accesses(0x34A1D3fff3958843C43aD80F30b94c510645C316)
    ...
    ├─ [0] VM::stopRecord()
    │   └─ ← [Return]
    ├─ [77447790] 0x34A1D3fff3958843C43aD80F30b94c510645C316::record(0x90193C961A926261B756D1E5bb255e67ff9498A1)
    │   ├─ [0] 0x90193C961A926261B756D1E5bb255e67ff9498A1::record()
    │   │   └─ ← [Return]
    │   └─ ← [Stop]
    ├─ [0] VM::accesses(0x34A1D3fff3958843C43aD80F30b94c510645C316)
...
Traces:
  [105728922] RecordLogsTest::setUp()
    ├─ [105691179] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] 12583 bytes of code
    └─ ← [Stop]

  [201032171] RecordLogsTest::testEmitRecordEmit()
    ├─ [105691037] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(1, 2, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae9e9a2e1e0c169350)
    │   ├─ emit LogTopic12(topic1: 1, topic2: 2, data: 0x43a26051362b8040b289abe93334a5e3662751aa691185ae9e9a2e1e0c169350)
    │   └─ ← [Stop]
    ├─ [0] VM::recordLogs()
    │   └─ ← [Return]
    ├─ [95285555] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(3, 0x2e38edeff9493e0004540e975027a429)
...
Traces:
  ...
  [105738908] RecordLogsTest::testRecordOffGetsNothing()
    ├─ [105689918] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(1, 2, 3, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae9e9a2e1e0c1693502e38edeff9493e0004540e975027a429)
...
Traces:
  ...
  [364426505] RecordLogsTest::testRecordOnEmitDifferentDepths()
    ├─ [0] VM::recordLogs()
    │   └─ ← [Return]
    ├─ emit LogTopic(topic1: 1, data: 0x43a26051362b8040b289abe93334a5e3)
    ├─ [105690556] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(2, 3, 0x43a26051362b8040b289abe93334a5e3662751aa)
    │   ├─ emit LogTopic12(topic1: 2, topic2: 3, data: 0x43a26051362b8040b289abe93334a5e3662751aa)
    │   └─ ← [Stop]
    ├─ [95281733] → new <unknown>@0x90193C961A926261B756D1E5bb255e67ff9498A1
    │   └─ ← [Return] 10554 bytes of code
    ├─ [85902300] 0x90193C961A926261B756D1E5bb255e67ff9498A1::emitEvent(4, 5, 6, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae)
    ...
    ├─ [77444655] 0x90193C961A926261B756D1E5bb255e67ff9498A1::getEmitterAddr() [staticcall]
...
Traces:
  ...
  [105709446] RecordLogsTest::testRecordOnSingleLog()
    ├─ [0] VM::recordLogs()
    │   └─ ← [Return]
    ├─ [105693489] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(1, 2, 3, 0x4576656e74204461746120696e20537472696e67)
...
Traces:
  ...
  [105742945] RecordLogsTest::testRecordOnSingleLogTopic0()
    ├─ [0] VM::recordLogs()
    │   └─ ← [Return]
    ├─ [105689706] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(0x43a26051362b8040b289abe93334a5e3662751aa691185ae9e9a2e1e0c1693502e38edeff9493e0004540e975027a429)
...
Traces:
  ...
  [434267127] RecordLogsTest::testRecordsConsumednAsRead()
    ├─ [105692485] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(1, 0x43a26051362b8040b289abe93334a5e3)
    ...
    ├─ [0] VM::getRecordedLogs()
    │   └─ ← [Return] []
    ├─ [95286184] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(2, 3, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae)
    ...
    ├─ [85904475] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(4, 5, 6, 0x43a26051362b8040b289abe93334a5e3662751aa)
    │   ├─ emit LogTopic123(topic1: 4, topic2: 5, topic3: 6, data: 0x43a26051362b8040b289abe93334a5e3662751aa)
    │   └─ ← [Stop]
    ├─ [77445610] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(0x43a26051362b8040b289abe93334a5e3662751aa691185ae9e9a2e1e0c169350)
    ...
    ├─ [69819517] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(7, 8, 9, 0x2e38edeff9493e0004540e975027a429ee666d1289f2c7a4)
...
Traces:
  [201067269] StateDiffTest::setUp()
    ├─ [105691177] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] 5531 bytes of code
    ├─ [95283480] → new <unknown>@0x90193C961A926261B756D1E5bb255e67ff9498A1
    │   └─ ← [Return] 6405 bytes of code
    └─ ← [Stop]

  [105722386] StateDiffTest::testCallAcceses()
    ├─ [0] VM::startStateDiffRecording()
    │   └─ ← [Return]
    ├─ [105693544] 0x34A1D3fff3958843C43aD80F30b94c510645C316::setter(55)
    │   └─ ← [Stop]
...
Traces:
  ...
  [105730906] StateDiffTest::testCallProxyAcceses()
    ├─ [0] VM::startStateDiffRecording()
    │   └─ ← [Return]
    ├─ [105693551] 0x90193C961A926261B756D1E5bb255e67ff9498A1::proxyCall(55)
...
Traces:
  ...
  [105745173] StateDiffTest::testCreateAcceses()
    ├─ [0] VM::startStateDiffRecording()
    │   └─ ← [Return]
    ├─ [105690894] → new <unknown>@0xA8452Ec99ce0C64f20701dB7dD3abDb607c00496
    │   └─ ← [Return] 5531 bytes of code
    ├─ [0] VM::stopAndReturnStateDiff()
