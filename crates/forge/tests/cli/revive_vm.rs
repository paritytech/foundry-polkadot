...
Traces:
  [3895361] CounterTest::setUp()
    ├─ [1291514] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
...
Traces:
  [3873734] RecordTest::testRecordAccess()
    ├─ [1250013] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] 4095 bytes of code
    ├─ [1250012] → new <unknown>@0xA8452Ec99ce0C64f20701dB7dD3abDb607c00496
...
Traces:
  [1287757] RecordLogsTest::setUp()
    ├─ [1250014] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
...
Traces:
  ...
  [5263375] RecordLogsTest::testRecordOnEmitDifferentDepths()
    ...
    │   └─ ← [Stop]
    ├─ [1301614] → new <unknown>@0xA8452Ec99ce0C64f20701dB7dD3abDb607c00496
