...
Traces:
  [3895361] CounterTest::setUp()
    ├─ [1291514] → new <unknown>@0x7D8CB8F412B3ee9AC79558791333F41d2b1ccDAC
...
Traces:
  [1287757] RecordLogsTest::setUp()
    ├─ [1250014] → new <unknown>@0x7D8CB8F412B3ee9AC79558791333F41d2b1ccDAC
...
Traces:
  ...
  [5263375] RecordLogsTest::testRecordOnEmitDifferentDepths()
    ...
    │   └─ ← [Stop]
    ├─ [1301614] → new <unknown>@0x5615dEB798BB3E4dFa0139dFa1b3D433Cc23b72f
