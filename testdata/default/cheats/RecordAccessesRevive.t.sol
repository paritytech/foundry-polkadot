...
contract RecordAccountAccessesTest is Test {
    ...
    function testRecordAccountAccesses() public {
        ...
        expectedStateDiff =
            string.concat(expectedStateDiff, "\ncontract: default/cheats/RecordAccessesRevive.t.sol:SelfCaller");
